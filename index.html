...
<head>
  ...
  <style>
    ...
    /* Lane renderer */
    .lane-wrap{ display:inline; }
    .lane-first{ display:inline; }
    .lane-more{
      margin-left:6px; padding:0 8px; border:1px solid var(--border); background:var(--card);
      border-radius:8px; cursor:pointer; font-size:12px;
    }
    .lane-full{ margin-top:6px; padding:6px; background:var(--row-alt); border:1px dashed var(--border); border-radius:8px; }
...
<body>
  ...
  <!-- măriți numărul la fiecare update -->
  <script defer src="./app.js?v=53"></script>
</body>
</html>
